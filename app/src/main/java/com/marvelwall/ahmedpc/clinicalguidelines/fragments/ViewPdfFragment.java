...
public class ViewPdfFragment extends Fragment {
    ...
    public static ViewPdfFragment newInstance(String bookName,int pageIndex) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pdfView.fromAsset(getArguments().getString("bookName"))
                .defaultPage(getArguments().getInt("pageIndex")-1) .onRender(new OnRenderListener() {
            @Override
